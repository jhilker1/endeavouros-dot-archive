...
#+hugo_custom_front_matter: :subtitle "Jacob's Literate Emacs Config"
#+author: Jacob Hilker
#+startup: fold
...
#+begin_warning
This config file is no longer being updated. I am currently using [[github:hlissner/doom-emacs][Doom Emacs]] for my emacs config.
#+end_warning
